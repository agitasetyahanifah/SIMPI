...
<body class="g-sidenav-show bg-gray-100">
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg">
    ...
    <div class="container-fluid py-2">
      <div class="mt-3 mb-2">
        <a href="{{ route('guest.blog.index') }}"><i class="fa fa-arrow-left mt-3 mb-3 mx-2" style="font-size: 12pt;"></i>Back</a>
      </div>
      <div class="row">
              ...
              <div class="row g-0">
                ...
                <div class="col-md-8">
                  <div class="card-body">
                    ...
                    <p class="card-text">{{ Str::words(strip_tags($latestBlog->body), 12, '...') }} <a href="{{ route('guest.blog.detail-blog', $latestBlog->id) }}" style="color: aqua;">More</a></p>
