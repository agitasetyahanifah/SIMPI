                                    ...
                                    <form method="POST" action="{{ route('admin.sewapemancingan.updateHargaSpot') }}">
                                        ...
                                        <div class="modal-body">
                                            <div class="mb-3">
                                                ...
                                                <input type="number" class="form-control" id="newPrice" name="price" value="{{ $memberPrice }}" required>
                                            </div>
                                    ...
                                    <form method="POST" action="{{ route('admin.sewapemancingan.updateHargaSpot') }}">
                                        ...
                                        <div class="modal-body">
                                            <div class="mb-3">
                                                ...
                                                <input type="number" class="form-control" id="newNonMemberPrice" name="price" value="{{ $nonMemberPrice }}" required>
                                            </div>
...
{{-- Javascript search customer name --}}
<script>
    document.addEventListener('DOMContentLoaded', function() {
        const searchInput = document.getElementById('customer_search_input');
        const selectElement = document.getElementById('customer_name_member');

        // Fungsi untuk melakukan filter opsi di dalam select
        ...
        // Fungsi untuk sinkronisasi input pencarian dengan select yang dipilih
