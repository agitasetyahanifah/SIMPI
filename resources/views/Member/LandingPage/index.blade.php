      ...
      <div class="card-body">
        ...
        <div class="row mt-3">
          <div class="text-center">
            <a href="{{ route('member.galeri.index') }}" class="btn btn-primary btn-sm rounded-pill">More <i class="ms-2 fas fa-chevron-right" style="font-size: 10pt"></i></a>
          </div>
        </div>
        ...
        <div class="row mt-3">
          <div class="text-center">
            <a href="{{ route('member.blog.index') }}" class="btn btn-primary btn-sm rounded-pill">More <i class="ms-2 fas fa-chevron-right" style="font-size: 10pt"></i></a>
          </div>
        </div> 
        ...
        <div class="row mt-3">
          <div class="text-center">
            <a href="{{ route('member.daftar-alat.index') }}" class="btn btn-primary btn-sm rounded-pill">More <i class="ms-2 fas fa-chevron-right" style="font-size: 10pt"></i></a>
          </div>
        </div>   
